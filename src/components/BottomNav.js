...
const BottomNav = () => {
  return (
    <div className="grid grid-cols-3 fixed bottom-0 left-0 right-0 border-t-[1px] border-[#1F2937] text-[#374151] font-medium text-center w-screen m-0 p-0 h-16 bg-bgSecondary">
